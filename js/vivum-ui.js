...
const ELEMENTS = [
  ...
  { id: 11, name: 'Plant',  color: '#007d27' },
  { id: 16, name: 'Oil',    color: '#2a200e' },
  { id: 19, name: 'Seed',   color: '#8db828' },
  { id: 18, name: 'Fungus', color: '#9b009b' },
  { id: 4,  name: 'Gas',    color: '#9090c8' },
  { id: 13, name: 'Stone',  color: '#808088' },
  { id: 1,  name: 'Wall',   color: '#9ba2b2' },
  { id: 14, name: 'Dust',   color: '#d9a060' },
  { id: 15, name: 'Mite',   color: '#f5e8a8' },
  { id: 12, name: 'Acid',   color: '#22ff44' },
  { id: 17, name: 'Rocket', color: '#c0c0c8' },
  { id: 5,  name: 'Cloner', color: '#ee00ee' },
  { id: 20, name: 'Wind',   color: '#7ecfef', virtual: true },
  { id: 0,  name: 'Erase',  color: '#555555' },
];
